...
\section{Discussion of Examples and RH5 Integration}
This section contains a brief overview of some of the examples that have been modified. Please note that \textbf{core explanations have been added to the examples where seemed appropriate}. All figures and additionaly videos are contained in this repository within the /media directory. 
...
\subsubsection{Integration Work}
...
\end{itemize}
\subsubsection{Results: Performing two Steps}
\begin{figure}[h!]
\centering
\begin{subfigure}{.4\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{Media/Crocoddyl/RH5/RH52StepsSolution.png}
  \caption{Optimal Trajectory and Conrol Inputs}
\end{subfigure}%
\begin{subfigure}{.4\textwidth}
  \centering
  \includegraphics[width=1\linewidth]{Media/Crocoddyl/RH5/RH52StepsConvergence.png}
